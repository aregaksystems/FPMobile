<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RquestApproval.aspx.cs" Inherits="FP_MobileApp.RquestApproval" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="row">
            <table id="table" 
                ...
                data-url="../Handlers/ApprovalRequest.ashx?id=2&userID=<%=HttpContext.Current.User.Identity.Name%>"
    ...
    <script type="text/javascript">
        ...
        window.actionEvents = {
            'click .like': function (e, value, row, index) {
                var id = row.id;
                window.location = "EditApproval.aspx?rid=" + id;
        ...
        $(function () {
            ...
            $('#RquestApproval').addClass('active');
